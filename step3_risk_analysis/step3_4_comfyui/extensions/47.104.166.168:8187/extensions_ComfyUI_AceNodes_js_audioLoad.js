...
function audioLoad(node, inputName, inputData, app) {
...
ComfyWidgets.AUDIOLOAD = audioLoad;

app.registerExtension({
	name: "AceNodes.AudioLoad",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData?.name == "ACE_AudioLoad") {
			nodeData.input.required.upload = ["AUDIOLOAD"];
		}
	},
});
