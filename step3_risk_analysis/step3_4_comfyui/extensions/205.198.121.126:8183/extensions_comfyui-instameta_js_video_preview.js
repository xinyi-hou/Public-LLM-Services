...
const ImvideoPreview = {
  name: "instameta.VideoPreview",
  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    if (nodeData.name !== "TopazVideoEnhancer" && nodeData.name !== "RifeNode" && nodeData.name !== "PreviewVideoNode" && nodeData.name !== "CombineNode") {
	 return
    }
...
app.registerExtension(ImvideoPreview);